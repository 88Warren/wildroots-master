...
<html lang="en">
    ...
    <div class="getInTouch">
        ...
        <div id="footer4">
            ...
            <div id="docs">
            <a href="docs/footer/Booking our Services.pdf"  target="_blank">Booking Our Services</a>|<a href="docs/footer/EnvironmentalPolicies.pdf"  target="_blank">Environmental Policies</a>|<a href="docs/footer/Website Policies.pdf" target="_blank">Website Policies</a>|<a href="docs/footer/missionStatement.pdf" target="_blank">Mission Statement</a>
            </div>
            <div id="weddingLinks"> 
